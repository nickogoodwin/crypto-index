	...
	{:else}
		...
		>
			...
			>
				...
				<input
					class="appearance-none border-none outline-none w-full py-2 px-4 rounded-full bg-zinc-900 text-white"
					type="text"
					name="name"
					id="name"
					bind:value={name}
				...
				<textarea
					class="appearance-none border-none resize-none outline-none w-full py-2 px-4 rounded-2xl bg-zinc-900 text-white h-36"
					name="message"
					id="message"
					bind:value={message}
				/>
